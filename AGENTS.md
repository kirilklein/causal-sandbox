...
- Do not use long tables of participants, resamples, or study results as learner-facing inspection views. Show the pattern with a graph and expose individual values through the visual when useful; do not hide a data dump in an expandable section.
