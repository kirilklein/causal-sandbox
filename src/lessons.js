...
function update() {
  ...
  if (state.level === 9) {
    ...
    document.querySelector("#lesson-graph").innerHTML = `
      ...
      </svg><p class="sample-note">Treatment and outcome models: adjusting for C. Dashed paths: unmeasured smoking status. Thicker, darker paths mean stronger influence as the slider increases; faint paths at zero are inactive.</p>`;
    return;
  }
