...
<header><a class="brand" href="./">${icon}<span>causal<span class="brand-dot">.</span></span></a><a class="lessons-link" href="./">Start the lessons</a><button id="methods" class="text-button">How this world works <span>↗</span></button></header>
