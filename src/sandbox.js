...
<div class="workspace"><section class="world panel"><div class="panel-heading"><div><span class="step">01</span><h2>The causal world</h2></div><button id="truth" class="text-button">◉ Hide causal truth</button></div><p class="panel-description">Adjustable arrows grow thicker and darker as their strength increases within each slider’s range. Faint arrows at zero are inactive; width shows magnitude, not sign.</p>
