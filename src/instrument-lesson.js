...
const lessons = [
  ...
  },
  {
    ...
    detail:
      '<p>Imagine Z is a randomly assigned invitation to take treatment. It adds treatment variation unrelated to the hidden confounder U, which affects both treatment and outcome.</p><p>Adjusting for Z removes that variation while leaving A ← U → Y open. U can then account for more of the remaining treatment differences, amplifying the existing bias. C remains adjusted for in both comparisons.</p><p>This is ordinary covariate adjustment. IV estimation instead uses the treatment variation supplied by Z.</p><p>Amplification is an across-studies tendency in this experiment, not a guarantee in every sample or causal world. Compare the pattern across independent studies.</p><p><a href="https://arxiv.org/abs/1701.04177">Read more: when instruments amplify bias</a></p>',
