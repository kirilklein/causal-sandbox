...
document.querySelector("#app").innerHTML =
    ...
    <div id="example-panel" hidden>
      ...
      <section id="adjustment-detail" hidden aria-labelledby="adjustment-title">
        ...
        <details id="baseline-explanation" hidden><summary>Why does adjusting for the score connect P and R?</summary>
          ...
          <p><a href="?sandbox=graph-lab&preset=pkr">Explore P–K–R in the Graph sandbox →</a> <small>Start a separate, editable experiment.</small></p>
        </details>
      </section>
    </div>
  </section>
  ...
  <p><a href="?lesson=time-varying-confounding">When treatment changes the next treatment decision →</a><br/><span class="help">Extend this timeline to two visits and see why updated health can be both a mediator and a confounder.</span></p>
  <p><a href="?lesson=causal-relevance">Does better prediction mean a better causal estimate? →</a><br/><span class="help">Separate causing an outcome, predicting it, and helping with adjustment.</span></p>
