...
document.querySelector("#app").innerHTML =
  ...
  <p><a href="?lesson=causal-relevance">Should we adjust for this measurement? →</a><br/><span class="help">Separate causing an outcome, predicting it, and helping with adjustment.</span></p>
