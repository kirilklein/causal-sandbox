...
document.querySelector("#app").innerHTML =
  ...
  <p><a href="?lesson=causal-relevance">Proxies for hidden confounders →</a><br/><span class="help">Use an observed consequence of a hidden confounder to partially account for it.</span></p>
